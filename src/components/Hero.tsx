      ...
      const ctx = gsap.context(() => {
        ...
        if (titleWords.length) {
          tl.fromTo(titleWords,
            ...
            { yPercent: 0, opacity: 1, rotateX: 0, duration: 1.2, stagger: 0.06, ease: 'power4.out', immediateRender: false },
            '-=0.4',
          )
        }
        ...
        tl.fromTo('[data-hero-stat]',
          { y: 30, opacity: 0 },
          { y: 0, opacity: 1, duration: 0.5, stagger: 0.08, immediateRender: false },
          '-=0.3',
        )

        // Decorative blobs breathing
  ...
  return (
    <section ref={root} id="top" className="relative overflow-hidden pt-32 pb-20 md:pt-44 md:pb-32 min-h-screen flex flex-col justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div
          data-hero-parallax
          className="pointer-events-none absolute -top-28 -right-28 h-[400px] w-[400px] rounded-full opacity-20 blur-[60px] will-change-transform"
          style={{ background: 'radial-gradient(circle, #d97757 0%, transparent 70%)' }}
          aria-hidden
        />
        <div
          data-hero-parallax
          className="pointer-events-none absolute top-20 -left-36 h-[380px] w-[380px] rounded-full opacity-15 blur-[60px] will-change-transform"
          style={{ background: 'radial-gradient(circle, #c2c0b6 0%, transparent 70%)' }}
          aria-hidden
        />
        <div
          data-hero-parallax
          className="pointer-events-none absolute bottom-0 right-1/4 h-[200px] w-[200px] rounded-full opacity-15 blur-[50px] will-change-transform"
