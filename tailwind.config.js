    ...
    extend: {
      colors: {
        ...
        terracotta: {
          ...
          light: '#d97757',
          dark: '#b85533',
          50: 'rgba(201, 100, 66, 0.05)',
          100: 'rgba(201, 100, 66, 0.1)',
          200: 'rgba(201, 100, 66, 0.2)',
        },
        parchment: '#f5f4ed',
        ivory: '#faf9f5',
        sand: '#e8e6dc',
      ...
      boxShadow: {
        ...
        'btn-primary': '0 1px 2px rgba(201, 100, 66, 0.3), 0 4px 12px rgba(201, 100, 66, 0.15)',
        'btn-primary-hover': '0 2px 4px rgba(201, 100, 66, 0.4), 0 8px 24px rgba(201, 100, 66, 0.25)',
        ...
        'glow': '0 0 40px rgba(201, 100, 66, 0.15)',
      },
      maxWidth: {
        content: '1200px',
      },
